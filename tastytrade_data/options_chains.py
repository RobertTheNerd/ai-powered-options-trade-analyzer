...
# Load credentials from shared config module
...
def get_options_contracts():
    ...
    for company in companies:
        ...
        try:
            ...
            company_options = {
                "company": company,
                "current_stock_price": step1_data["stock_prices"][company][
                    "current_price"
                ],
                "expiration_dates": {},
                "total_contracts": 0,
            ...
            print(
                f"   🎯 Total for {company}: {company_options['total_contracts']} contracts"
            )
